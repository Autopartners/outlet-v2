  ...
  return (
    <Container p={0} fluid>
      ...
      >
        ...
        >
          <Text c="white" fz={40} mb="md">Добро пожаловать на аукцион CarsOutlet!</Text>
          <Text c="white" fz={20}>Продажа подержанных автомобилей от собственника</Text>
        </Box>
      </Box>
      <Box ta={'center'} py={20} bg={'gray.1'}>
        ...
        <Button leftSection={<IconEye />} mt={20} size={'lg'} onClick={() => nav('/lots')}>Смотреть все</Button>
      </Box>
      <Box ta={'center'} mt={20} w={'60%'} mx={'auto'}>
        <Text fz={40}>Наши преимущества</Text>
        <Divider mx={'auto'} w={100} color={'blue.3'} size={5} style={{ borderRadius: 20 }} />
        <Text fz={20} mt={15}>Почему стоит выбрать наш аукцион для покупки подержанного автомобиля</Text>
